...
var Commands = {
    getbotauthor : {
        text : "<b>Bhargab Hazarika\n</b>"
                +"<b>Code Name - MaxySpark\n</b>"
                +"<b>Email - devmaxyspark@gmail.com\n</b>"
                +"<b>Github -<b>"+" <a href='https://github.com/MaxySpark'>MaxySpark</a>\n"
                +"<b>Facebook -</b>"+" <a href='https://fb.me/MaxySparx'>MaxySpark</a>\n"
                +"<b>Telegram - @MaxySpark</b>",             
        parse_mode : "HTML",
    },
    getsyllabus : {
        text : "Select Course\n"
